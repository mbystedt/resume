...
export class Experience {
  ...
  protected readonly experiences = [
  {
    ...
    division: "Ministry of Water, Land and Resource Stewardship – Natural Resource Information and Digital Services",
  ...
  //     division: 'Ministry of Water, Land and Resource Stewardship',
  //     title: 'Full Stack Developer',
  //     summary: 'Natural Resource Information and Digital Services – Deployment automation & modernization',
  //     description: [`lalala`],
  //     projects: [
  //       {
